...
public class StreamKeyInfo {
  ...
  public String toString() {
    return "StreamKeyInfo [publishers=" + publishers + ", key=" + key + ", data=" + data
        + ", confirmations=" + confirmations + ", blockhash=" + blockhash + ", blockindex="
        + blockindex + ", blocktime=" + blocktime + ", txid=" + txid + ", vout=" + vout + ", valid="
        + valid + ", time=" + time + ", timereceived=" + timereceived + "]";
  }
