...
public class Stream {
  ...
  public String toString() {
    return "Stream [name=" + name + ", createtxid=" + createtxid + ", streamref=" + streamref
        + ", open=" + open + ", details=" + details + ", creators=" + creators + ", subscribed="
        + subscribed + ", synchronized_=" + synchronized_ + ", items=" + items + ", confirmed="
        + confirmed + ", keys=" + keys + ", publishers=" + publishers + "]";
  }
  ...
  /**
   * @param synchronized_ the synchronized_ to set
   */
